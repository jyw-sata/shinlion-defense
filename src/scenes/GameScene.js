...
// Bug definitions
const BUG_TYPES = {
  ant:      { texture: 'bug_ant_img',      hp: 1, speed: 60,  reward: 10, scale: 1.0, name: '개미' },
  beetle:   { texture: 'bug_beetle_img',   hp: 2, speed: 45,  reward: 20, scale: 1.0, name: '딱정벌레' },
  mosquito: { texture: 'bug_mosquito_img', hp: 1, speed: 90,  reward: 15, scale: 1.0, name: '모기' },
  bee:      { texture: 'bug_bee_img',      hp: 2, speed: 80,  reward: 25, scale: 1.0, name: '벌' },
  spider:   { texture: 'bug_spider_img',   hp: 10, speed: 30, reward: 100, scale: 1.2, name: '거미' },
};
